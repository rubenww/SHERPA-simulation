...
#         for 
    ...
    print("Starting simulation of sectors: %s" % sector_lst, flush=True)
    ...
    print("First loop over all sectors finished. Now reducing all sectors together.", flush=True)
    ...
    print("Finished, saving to NetCDF", flush=True)
